...
export default defineComponent({
  ...
  setup(props: TreeProps, context: SetupContext) {
    ...
    provide('TREE_UTILS', {
      toggleNode, getChildren, toggleCheckNode, append, remove, onDragstart, onDragend, onDragleave, onDragover, onDrop
    })
    return () => {
            ...
            loading: () => (
              slots.loading ?
                (
                  ...
                  <span class="ml-1">
                        <svg class="rotating-icon" height="16" width="16" viewBox="0 0 1024 1024"
      ...
      return (
        <div class="s-tree">{
          //如果用户设置了height这个props属性，就渲染虚拟滚动列表
          height?.value ?
            (
              <div style={{height: `${height.value}px`}}>
                <VirtualList data={expandedTree.value} itemHeight={itemHeight.value}>
                  {{
